...
class CursoDetalhesScreen extends StatelessWidget {
  CursoDetalhesScreen({Key? key}) : super(key: key);

  late CursoModel cursoModel;

  @override
  Widget build(BuildContext context) {
    cursoModel = ModalRoute.of(context)!.settings.arguments as CursoModel;
